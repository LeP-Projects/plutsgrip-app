...
def upgrade() -> None:
    ...
    budgetperiod_enum = sa.Enum('MONTHLY', 'QUARTERLY', 'YEARLY', name='budgetperiod')
    budgetperiod_enum.create(op.get_bind(), checkfirst=True)

    # Create recurrencefrequency enum type
    recurrencefrequency_enum = sa.Enum('DAILY', 'WEEKLY', 'BIWEEKLY', 'MONTHLY', 'QUARTERLY', 'YEARLY', name='recurrencefrequency')
    recurrencefrequency_enum.create(op.get_bind(), checkfirst=True)
    ...
    sa.Column('frequency', sa.Enum('DAILY', 'WEEKLY', 'BIWEEKLY', 'MONTHLY', 'QUARTERLY', 'YEARLY', name='recurrencefrequency'), nullable=False),
